...
<html>
	...
	<body>
		<a href="#edit-parecerRH" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-parecerRH" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${parecerRHInstance?.version}" />
				<fieldset class="form">
