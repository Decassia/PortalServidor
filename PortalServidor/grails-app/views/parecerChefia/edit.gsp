...
<html>
	...
	<body>
		<a href="#edit-parecerChefia" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-parecerChefia" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${parecerChefiaInstance?.version}" />
				<fieldset class="form">
